...
ANCHOR_GROUP_RULES = {
    ...
    "installation_modes_storage": [
        ...
        "modos de trabajo preconfigurados",
    ],
    ...
    "installation_motion_defaults": [
        ...
        "aceleracion lineal",
        "control del gap",
        "sincronizacion de cabezales",
        "cinematica por defecto",
    ],
    ...
    "error_code_condition_attribute": [
        "0008",
        "error 0008",
        "tecla ha sido rechazada",
        "0169",
        "error 0169",
        "sobrepasada temperatura de seguridad",
        "0173",
        "error 0173",
        "1067",
        "error 1067",
        ...
        "error 8042",
        "50 mb",
        "memoria en disco por debajo del minimo recomendado",
    ],
...
TECHNICAL_TOKEN_PATTERNS = {
    ...
    "mtb_m": r"\bmtb_m\b",
    "mtb": r"\bmtb\b",
    "torqdist": r"\btorqdist\b",
    "warncoupe": r"\bwarncoupe\b",
    "maxcoupe": r"\bmaxcoupe\b",
    "unidir": r"\bunidir\b",
    "hirth": r"\bhirth\b",
    "rio5": r"\brio5\b",
    "plcdatasize": r"\bplcdatasize\b",
    "plctype": r"\bplctype\b",
    "ndimod": r"\bndimod\b",
    "hbh3": r"\bhbh3\b",
    "hbh4": r"\bhbh4\b",
    "gapapproachdyn": r"\bgapapproachdyn\b",
    "slopetype": r"\bslopetype\b",
    "synccancel": r"\bsynccancel\b",
    "kinid": r"\bkinid\b",
    "overtemp": r"\bovertemp\b",
    "e173": r"\be173\b",
    "w169": r"\bw169\b",
    "0008": r"\b0008\b",
    "0040": r"\b0040\b",
    ...
    "pit": r"(?:\.pit\b|\bpit\b)",
    "oem": r"\boem\b",
    "geometry_error": r"error\s+de\s+geometria|geometry\s+error",
    "li_li16": r"\bli1(?:\s*a\s*li16|-li16)?\b",
    "lo_lo8": r"\blo1(?:\s*a\s*lo8|-lo8)?\b",
}
