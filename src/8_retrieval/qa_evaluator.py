...
EVALUATOR_ONLY_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("el cnc mantiene el historial de funciones g y m activas", "the cnc maintains the history of active g and m functions"),
    ...
    ("seran las del punto de interrupcion", "will be those of the interruption point"),
    ("la velocidad del husillo", "spindle speed"),
    ("velocidad del husillo", "spindle speed"),
    ("la herramienta", "tool"),
    ("otras ordenes programadas", "other commands that were programmed"),
    ("la tecla", "the key"),
    ("tecla", "key"),
