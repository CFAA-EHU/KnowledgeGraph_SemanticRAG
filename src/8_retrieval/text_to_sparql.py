...
ANCHOR_ALIAS_RULES = [
    ...
    {"anchor_id": "ekin_company", "aliases": ["empresa ekin", "ekin s coop", "direccion de ekin", "correo electronico de ekin", "derechos de autor", "correo de contacto de ekin"], "seed_uris": [f"{BASE_URI}Empresa_EKIN_S_Coop"], "preferred_intents": ["literal_lookup"], "confidence": 0.94},
