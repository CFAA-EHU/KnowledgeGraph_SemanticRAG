...
- trabajar sobre entidades canonicas y enriquecidas
...
El orquestador opera sobre el snapshot enriquecido y hereda:
- planner compartido
- sintesis compartida
...
Cuando el plan ya sea razonable, usa `semantic_rag.py` para comprobar si la sintesis comparte bien la misma evidencia y la verbaliza con calidad suficiente sobre el grafo enriquecido.
